...
public class IsyBindingConstants {
    ...
    public final static ThingTypeUID REMOTELINC_4_THING_TYPE = new ThingTypeUID(BINDING_ID, "remotelinc4");
    ...
    public final static String CHANNEL_DUALOUTLET_TOP = "outlet_top";
    public final static String CHANNEL_DUALOUTLET_BOTTOM = "outlet_bottom";
    // motion
    ...
    public final static String CHANNEL_KEYPAD_LINC_ACTION_A = "control_a";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_B = "control_b";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_C = "control_c";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_D = "control_d";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_E = "control_e";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_F = "control_f";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_G = "control_g";
    public final static String CHANNEL_KEYPAD_LINC_ACTION_H = "control_h";
