...
public class IsyRestDiscoveryService extends AbstractDiscoveryService {
    ...
    public IsyRestDiscoveryService(IsyBridgeHandler bridgeHandler) {
        super(Set.of(new ThingTypeUID(IsyBindingConstants.BINDING_ID, "-")), DISCOVER_TIMEOUT_SECONDS, false);
        ...
        mMapDeviceTypeThingType.put("01.22", IsyBindingConstants.DIMMER_THING_TYPE);
        ...
        mMapDeviceTypeThingType.put("00.10", IsyBindingConstants.REMOTELINC_4_THING_TYPE);
        mMapDeviceTypeThingType.put("00.1B", IsyBindingConstants.REMOTELINC_4_THING_TYPE);
        ...
        mMapDeviceTypeThingType.put("00.1A", IsyBindingConstants.REMOTELINC_8_THING_TYPE);
        ...
        mMapDeviceTypeThingType.put("05.0B", IsyBindingConstants.VENSTAR_THERMOSTAT_THING_TYPE);
